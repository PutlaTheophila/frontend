            ...
            <div className="p-6">
              ...
              <div className="space-y-2 max-h-[60vh] overflow-y-auto pr-2 custom-scrollbar">
                {sports.map((sport) => (
                  <Link
                    key={sport}
                    to={`/nso/mark-attendance/${selectedGroup === 'nso' ? 'nso' : 'interiit'}-attendance/${sport.toLowerCase().replace(/\s+/g, '-')}`}
